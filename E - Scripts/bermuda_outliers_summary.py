#!/usr/bin/env python
"""
Provides a summary of FDist / BayeScan outlier analyses
...
Order of SNPs in VCF file and outlier output files needs to be the same

Usage: python3 outlier_summary.py [vcf_filename] [fdist_hetfst_filename] 
               [outlier_folder] [bayescan_cutoff] [fdist_cutoff]
Example: python3 outlier_summary.py afra_2f.vcf 
                                    outlier_files/fdist_overall.txt 
                                    outlier_files 
                                    0.05 
                                    0.95
